...
each model using the training dataset before testing each one individually with the test dataset to gauge how robust they are.")
```
...
# Print the AUC
print(sprintf("The AUC for the AllVariableModel is %.2f%%, and the AUC for the topThreeModel is %.2f%%", allVariableModelAUC*100, topThreeModelAUC*100))
...
print(sprintf("The AUC for the training dataset using the allVariableModel is %.2f%%, and the AUC for the test dataset is %.2f%%", allVariableModelAUC*100, allVariableModelAUCTest*100))
...
print(sprintf("The AUC for the training dataset using the topThreeModel is %.2f%%, and the AUC for the test dataset is %.2f%%", topThreeModelAUC*100, topThreeModelAUCTest*100))
...
# TODO TIDY
#pred.ff <- predict(allVariablesLogisticRegressionModel, train_df, type = "response")
#contrasts(train_df$Churn)
#new_df <- createPrediction_df(allVariablesLogisticRegressionModel, train_df, oneClass = "Yes", zeroClass = "No")
#head(new_df)
#confusionMatrix(new_df$classification, train_df$Churn)
